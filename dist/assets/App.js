          ...
          messages.map((msg, i) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex gap-2 ${isMe ? "flex-row-reverse" : ""}`, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex flex-col max-w-[80%] ${isMe ? "items-end" : "items-start"}`, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `px-3 py-1.5 rounded-xl text-sm leading-relaxed ${isMe ? "bg-purple-600 text-white rounded-tr-sm" : "bg-dark-700 text-slate-200 rounded-tl-sm"}`, children: (() => {
