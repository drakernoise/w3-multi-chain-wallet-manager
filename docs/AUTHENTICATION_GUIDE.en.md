# Gravity Wallet - Authentication & 2FA Guide
...
## NEW: Passwordless Flow (Google & Device Key)
...
### Multi-Device Usage (Aegis + Google Auth at the same time)
...
- **Feedback:**
    - **Weak:** < 10 characters or too simple.
    - **Medium:** Acceptable but could be better.
    - **Strong:** Good combination.
