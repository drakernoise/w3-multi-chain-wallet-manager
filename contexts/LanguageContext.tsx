...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'help.chat_title': 'Secure Messenger',
        'help.chat_desc': 'Send encrypted messages on-chain.',
        'help.chat_warning': 'Messages are public but encrypted. Only sender/receiver can read.',
        'help.chat_cost': 'Cost per message: 0.001 (min transfer)',
        // Help Buttons
    ...
    fr: {
        ...
        'help.chat_title': 'Messagerie Sécurisée',
        'help.chat_desc': 'Envoyez des messages chiffrés sur la chaîne.',
        'help.chat_warning': 'Les messages sont publics mais chiffrés. Seuls l\'expéditeur et le destinataire peuvent lire.',
        'help.chat_cost': 'Coût par message : 0.001 (transfert min)',
        // Help Buttons
    ...
    de: {
        ...
        'help.chat_title': 'Sicherer Messenger',
        'help.chat_desc': 'Senden Sie verschlüsselte Nachrichten in der Chain.',
        'help.chat_warning': 'Nachrichten sind öffentlich, aber verschlüsselt. Nur Absender/Empfänger können lesen.',
        'help.chat_cost': 'Kosten pro Nachricht: 0.001 (Min. Transfer)',
        // Help Buttons
    ...
    it: {
        ...
        'help.chat_title': 'Messenger Sicuro',
        'help.chat_desc': 'Invia messaggi crittografati sulla catena.',
        'help.chat_warning': 'I messaggi sono pubblici ma crittografati. Solo mittente/destinatario possono leggere.',
        'help.chat_cost': 'Costo per messaggio: 0.001 (trasferimento min)',
        // Help Buttons
