                ...
                <div className="flex flex-col items-center justify-center space-y-8">
                    {status === 'connected' ? (
                        ...
                        <>
                            ...
                            {qrData && (
                                <div className="w-full mt-4 p-3 bg-dark-900/80 rounded-2xl border border-dark-700/50 animate-fadeIn">
                                    <p className="text-[9px] text-slate-500 uppercase font-black tracking-widest mb-2 opacity-70">Manual Pairing String</p>
                                    <div className="flex gap-2">
                                        <code className="flex-1 text-[9px] text-purple-400 font-mono break-all line-clamp-2 select-all cursor-pointer bg-black/40 p-2 rounded-lg border border-purple-500/10">
                                            {qrData}
                                        </code>
                                        <button
